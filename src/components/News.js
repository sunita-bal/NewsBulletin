...
export class News extends Component {
    ...
    constructor(props) {
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)} NEWS-BULLETIN`;
    }
    async updateNews() {
    ...
    render() {
        return (
            <div className="container my-3">
                <h2 className="text-center " style={{ margin: '100px' }}>NEWS BULLETIN-Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h2>
